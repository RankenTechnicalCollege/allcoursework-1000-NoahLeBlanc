...
const Student = (props) => {
  ...
  return (
    <div className="card">
      <img src={props.student.image} alt="Our Student" className="card-img=top mx-auto" />
      {!editMode && (
        <ul className="list-group list-group-flush">
          ...
          <button type="button" className="btn btn-danger" onClick={() => props.removeStudent(props.student)}>
            Delete Student <FontAwesomeIcon icon={faWarning} />
          </button>
          <button type="button" className="btn btn-warning" onClick={() => setEditMode(true)}>
            Edit Student <FontAwesomeIcon icon={faMagicWandSparkles} />
          </button>
        </ul>
      )}
      {editMode && (
        <ul className="list-group list-group-flush">
          ...
          <li className="list-group-item text-center">
            <button type="button" className="btn btn-secondary" onClick={saveStudent}>
